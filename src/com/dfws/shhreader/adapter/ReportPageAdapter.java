...
/**
 * @file： ReportPageAdapter.java
 * @Page： com.dfws.shhreader.adapter
 * @description：  报告 新闻 适配器 
 * @since： 2013-10-31
...
public class ReportPageAdapter extends BaseAdapter{
	 ...
	 */
	public ReportPageAdapter(Context context,List<News> newsList,ListView mListView) {
		if (newsList!=null) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		ViewCache viewCache=null;Log.i("Fragment", "ReportPageAdapter>> getView");
		if (convertView==null) {
		...
		if (news!=null) {
			...
			if (!TextUtils.isEmpty(img_path)) {
				...
				bitmap=loader.loadImage("ReportPageAdapter",img_path, names, new Callback() {
