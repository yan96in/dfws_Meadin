...
public class FigurePagerAdapter extends BaseAdapter {
	 ...
	 */
	public FigurePagerAdapter(Context context,List<News> newsList,ListView mListView) {
		if (newsList!=null) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		ViewCache viewCache=null;Log.i("Fragment", "FigurePagerAdapter>> getView");
		if (convertView==null) {
		...
		if (news!=null) {
			...
			if (!TextUtils.isEmpty(img_path)) {
				...
				bitmap=loader.loadImage("FigurePagerAdapter",img_path, names, new Callback() {
